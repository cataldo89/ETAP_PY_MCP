...
"""Example for the EtapClient > Scenario > getxmlfilepath section.
...
# Returns the file path of the scenario XML file for the current project.
result = e.scenario.getxmlfilepath()
print(result)
